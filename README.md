...
When new is called this refers to the specific instance of the object
Whenever call or apply is used you set the this keyword explicitly to the passed parameter
